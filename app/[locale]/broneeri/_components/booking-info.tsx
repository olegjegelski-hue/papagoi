  ...
  return (
    <section className="py-16 bg-gradient-to-b from-papagoi-green-50 to-papagoi-beige-50" ref={ref}>
      <div className="container-custom">
        ...
        >
          <div className="bg-papagoi-blue-50 border border-papagoi-blue-200 rounded-2xl p-8 mb-8">
            <div className="flex items-center mb-4">
              <Info className="h-6 w-6 text-papagoi-blue mr-3" />
              <h3 className="text-xl font-semibold text-papagoi-blue-800">Oluline teada!</h3>
            </div>
            <div className="grid md:grid-cols-2 gap-6 text-papagoi-blue-700">
              <div>
