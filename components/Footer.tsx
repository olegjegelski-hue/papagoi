      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-warm-gray-300 mb-4 max-w-md leading-relaxed">
              Eesti ainulaadne papagoidekeskus, kus elab üle 26 papagoi 10+ liigist. 
              Tule tutvuge meie värvilise perekonnaga ja koge midagi erilist!
            </p>
            <div className="flex items-center space-x-2 text-sm text-warm-gray-400">
              <Heart className="w-4 h-4 text-papagoi-red" />
              <span>Tehtud armastusega papagoidele</span>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/papagoid" className="text-warm-gray-300 hover:text-papagoi-blue transition-colors duration-300">
                  Meie papagoid
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/broneeri" className="text-warm-gray-300 hover:text-papagoi-yellow transition-colors duration-300 font-medium">
                  Broneeri külastus
                </Link>
              </li>
            </ul>
        ...
        {/* Social Media */}
        <div className="border-t border-papagoi-green/20 mt-8 pt-6">
          <div className="flex flex-col items-center space-y-4 mb-6">
            <h4 className="text-lg font-semibold text-papagoi-green">Jälgi meid sotsiaalvõrgustikes</h4>
            <div className="flex space-x-6">
              ...
              >
                <div className="w-12 h-12 bg-[#1877F2] rounded-full flex items-center justify-center shadow-lg group-hover:shadow-xl">
                  <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                </div>
                <span className="text-sm text-warm-gray-300 group-hover:text-papagoi-blue transition-colors">Facebook</span>
              </a>
              <a 
                ...
                className="group flex flex-col items-center space-y-2 hover:scale-110 transition-transform duration-300"
              >
                <div className="w-12 h-12 bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-xl">
                  <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-sm text-warm-gray-300 group-hover:text-papagoi-red transition-colors">Instagram</span>
              </a>
              <a 
                ...
                className="group flex flex-col items-center space-y-2 hover:scale-110 transition-transform duration-300"
              >
                <div className="w-12 h-12 bg-[#FF0000] rounded-full flex items-center justify-center shadow-lg group-hover:shadow-xl">
                  <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                  </svg>
                </div>
                <span className="text-sm text-warm-gray-300 group-hover:text-papagoi-yellow transition-colors">YouTube</span>
              </a>
            </div>
          </div>
        </div>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-papagoi-green/20 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-warm-gray-400 text-sm">
            © 2025 Papagoi Keskus. Kõik õigused kaitstud.
          </p>
          <p className="text-warm-gray-400 text-sm mt-2 md:mt-0">
            Loodud armastusega Eesti papagoidekeskusele 
            <Heart className="w-3 h-3 text-papagoi-red inline ml-1" />
          </p>
        </div>
      </div>
    </footer>
