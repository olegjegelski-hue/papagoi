      ...
      <div className="container-custom relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
            {t('title')} <span className="text-yellow-300">{t('titleHighlight')}</span>
          </h2>
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto opacity-90">{t('subtitle')}</p>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-sm opacity-90">{t('easyBookingDesc')}</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              animate={inView ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }}
            ...
            >
              ...
              <h3 className="text-lg font-semibold mb-2">{t('uniqueExperience')}</h3>
              <p className="text-sm opacity-90">{t('uniqueExperienceDesc')}</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              animate={inView ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }}
            ...
            >
              ...
              <h3 className="text-lg font-semibold mb-2">{t('memories')}</h3>
              <p className="text-sm opacity-90">{t('memoriesDesc')}</p>
            </motion.div>
          </div>
          ...
          >
            <Link href="/broneeri">
              <Button size="lg" className="papagoi-cta-white shadow-xl group">
          ...
          >
            <p className="text-lg mb-2"><strong>{t('guarantee')}</strong></p>
            <p className="text-sm opacity-80">{t('guaranteeSub')}</p>
          </motion.div>
        </motion.div>
      </div>
